...
public class WageCalculator {
	...
	/**
	 * 
	 * This method calculates the sitters wage for family B. Function assumes inputs
	 * are proper.
	 * 
	 * 
	 */
	public static int familyBWageCalculation(String startTime, String endTime) {
		...
		if (parseEndTimeInteger <= tenPM) {
			...
			netPay += 16; // Since we know the end time is >= 10 PM we can assume full pay for 10 PM to 12
							// AM.
...
// excluding :
	...
	public static String getFamilyFromUser() {
		...
		while (!familyInput.equals("a") && !familyInput.equals("b") && !familyInput.equals("c")) {
			System.out.print("Error please enter either family A,B,C by entering the letter: ");
